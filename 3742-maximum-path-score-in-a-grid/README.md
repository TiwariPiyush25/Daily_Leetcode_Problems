<h2><a href="https://leetcode.com/problems/maximum-path-score-in-a-grid/?envType=problem-list-v2&envId=dynamic-programming">3986. Maximum Path Score in a Grid</a></h2><h3>Medium</h3><hr><p>You are given an <code>m x n</code> grid where each cell contains one of the values 0, 1, or 2. You are also given an integer <code>k</code>.</p>
