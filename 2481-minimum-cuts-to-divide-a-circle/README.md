<h2><a href="https://leetcode.com/problems/minimum-cuts-to-divide-a-circle/?envType=problem-list-v2&envId=math">2575. Minimum Cuts to Divide a Circle</a></h2><h3>Easy</h3><hr><p>A <strong>valid cut</strong> in a circle can be:</p>
